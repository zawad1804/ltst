...
<body>
    ...
    <main class="meals-container">
        ...
        <section class="glass-card meal-scheduler">
            ...
            <form action="schedule_meal.php" method="POST" class="scheduler-form" id="mealScheduleForm">
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" name="pay_instantly" id="pay_instantly">
                        Pay instantly for this meal
                    </label>
                </div>
    ...
    <script>
        ...
        document.getElementById('mealScheduleForm').addEventListener('submit', function(e) {
            e.preventDefault();
            
            if (document.getElementById('pay_instantly').checked) {
                const amount = document.getElementById('total_price').textContent.replace('৳', '');
                window.location.href = `payments.php?amount=${amount}&from=meal_schedule`;
            } else {
                this.submit();
            }
        });
